...
VALUES
('IS101', 'C101', 'The Catcher in the Rye', '2024-03-01', '978-0-553-29698-2', 'E101'),
('IS103', 'C103', 'One Hundred Years of Solitude', '2024-03-03', '978-0-14-118776-1', 'E103'),
('IS105', 'C105', 'Jane Eyre', '2024-03-05', '978-0-141-44171-6', 'E105'),
...
ON CONFLICT (issued_id) DO NOTHING;
